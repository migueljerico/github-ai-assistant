export const ur = {
  ...
  'chat.mode.auto': 'خودکار',
  'chat.mode.chat': 'رائے',
  'chat.mode.action': 'کارروائی',
  ...
  'history.empty': 'اس سیشن کی کارروائیاں یہاں دکھائی دیں گی',
  'history.exportLog': 'لاگ ایکسپورٹ کریں',
  'auth.verifying': 'Verifying authentication...',
  'auth.title': 'GitHub AI اسسٹنٹ',
  'auth.subtitle': 'قدرتی زبان میں اپنی GitHub رپوزٹریز کا انتظام کریں۔',
  'auth.patDivider': 'یا ذاتی ٹوکن استعمال کریں',
  ...
  'provider.gemini.model.flash37Desc': 'Gemini 3.7 Flash · ہائبرڈ استدلال اور جدید ترین رفتار · تازہ ترین نسل',
  'provider.gemini.model.flash38': 'Gemini 3.8 Flash',
  'provider.gemini.model.flash38Desc': 'Gemini 3.8 Flash · بہترین کارکردگی اور انتہائی رفتار · تازہ ترین نسل',
