export const id = {
  ...
  'header.subtitle': 'AI Multi-penyedia · API GitHub',
  ...
  'history.empty': 'Tindakan sesi ini akan muncul di sini',
  'history.exportLog': 'Ekspor log',
  'auth.verifying': 'Verifying authentication...',
  'auth.title': 'Asisten AI GitHub',
  'auth.subtitle': 'Kelola repositori GitHub Anda dengan bahasa alami,\nAI multi-penyedia dengan model gratis.',
  'auth.patDivider': 'atau gunakan token pribadi',
  'auth.connectGithub': 'Hubungkan dengan GitHub',
  'pat.hideToken': 'Sembunyikan token',
  'pat.showToken': 'Tampilkan token',
  'pat.verifying': 'Memverifikasi...',
  'pat.useManual': 'Gunakan token manual',
  'user.viewProfile': 'Lihat profil di GitHub',
  'user.logout': 'Keluar',
  'aipanel.title': 'Hubungkan Asisten AI Anda',
  'aipanel.subtitle': 'Your key is used only in your browser and is never sent to our servers',
  'aipanel.privacyBadge': '🔒 100% pribadi · Hanya di perangkat Anda',
  'aipanel.model': 'Model',
  ...
  'provider.gemini.model.flash37Desc': 'Gemini 3.7 Flash · Penalaran hibrida dan kecepatan mutakhir · Generasi terbaru',
  'provider.gemini.model.flash38': 'Gemini 3.8 Flash',
  'provider.gemini.model.flash38Desc': 'Gemini 3.8 Flash · Performa teroptimalkan dan kecepatan ekstrem · Generasi terbaru',
