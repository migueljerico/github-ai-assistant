export const en = {
  ...
  'provider.gemini.model.flash37Desc': 'Gemini 3.7 Flash · Hybrid reasoning and cutting-edge speed · Latest generation',
  'provider.gemini.model.flash38': 'Gemini 3.8 Flash',
  'provider.gemini.model.flash38Desc': 'Gemini 3.8 Flash · Optimized performance and extreme speed · Latest generation',
  ...
  // #58 (a): atomic multi-file bulk (single commit via Git Data API)
