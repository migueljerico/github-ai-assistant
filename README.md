...
![Versión](https://img.shields.io/badge/Versión-v3.3.0-blue?style=for-the-badge)
...
| 💬 **Documentar/publicar en lenguaje natural** | Con un archivo o repo en contexto, basta decir *"documéntalo"* o *"publícalo en el repo X"* y la app lo hace (genera la doc y abre el modal de publicar con el repo precargado). El chat te habla en **lenguaje claro**, no como un consultor técnico; el **documento** sí sale en registro profesional |
| 📦 **Publica también el archivo fuente** | Al publicar la documentación de un archivo, puedes subir además el **archivo original** (`.pbit`/`.pbix`/`.xlsx`…) al repo: como fichero en commit/Draft PR o como **asset** del Release. La documentación generada usa tu usuario y el año reales (sin inventar) |
