...
<p align="center">
  ...
  <a href="https://github.com/migueljerico/github-ai-assistant/releases"><img src="https://img.shields.io/badge/Versión-v4.0.42-blue?style=for-the-badge" alt="Versión" /></a>
...
|---|---|---|
| **Antigravity 2.0 · Gemini 3.8 Flash** | v4.0.41 → v4.0.42 (2026-09-03) | **v4.0.42:** corrección de CORS en llamadas directas a proveedores externos (`X-Timeout-Ms` condicionado a proxy interno vía `isProxyEndpoint`), incorporación de Gemini 3.8 Flash al catálogo de modelos con i18n en 13 idiomas, y corrección del layout en app móvil instalada (PWA standalone con `viewport-fit=cover`, `manifest.json`, padding `safe-area-inset-*` y `flex-shrink: 0` en barra inferior). Suite: 1.350 tests en verde (1.290 cliente + 60 servidor), lint limpio y build limpia. |
