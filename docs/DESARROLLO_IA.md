...
|---|---|
| **Antigravity 2.0 / Gemini 3.7 Flash** | Modelo activo en v4.0.35 (2026-08-19): extracción inteligente del resumen del repositorio para el "about" de GitHub (`extractRepoSummary` en `gemini.ts`), saneamiento de Markdown/HTML y acotación segura a 350 caracteres. Ampliación de tests unitarios (+11 tests en `gemini.test.ts`), alcanzando 1.283 tests unitarios en verde (1.223 cliente + 60 servidor) al 100% de cobertura en diff patch para Codecov y sincronización documental completa |
