...
| Proveedores de IA | Catálogo gestionado por la plataforma | Groq, Gemini, OpenRouter, NVIDIA NIM, Zenmux, OpenCode Zen, Cloudflare Workers AI, Ollama Cloud, Kilo, BazaarLink y QwenCloud |
...
| **Elegir proveedor de IA** | ✅ Groq, Gemini, OpenRouter, NVIDIA NIM, Zenmux, OpenCode Zen, Cloudflare Workers AI, Ollama Cloud, Kilo, BazaarLink y QwenCloud | Catálogo gestionado por GitHub |
