...
| Proveedores de IA | Catálogo gestionado por la plataforma | Groq, Gemini y OpenRouter |
...
| **Elegir proveedor de IA** | ✅ Groq, Gemini u OpenRouter | Catálogo gestionado por GitHub |
